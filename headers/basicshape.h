...
public:
	...
	void drawShape(Shader shader, glm::mat4 view, glm::mat4 projection, Camera camera)
	{
        ...
        glUniform3f(glGetUniformLocation(shader.Program, "pointLights[0].diffuse"), 0.4f, 0.4f, 0.4f); 
        glUniform3f(glGetUniformLocation(shader.Program, "pointLights[0].specular"), 0.4f, 0.4f, 0.4f); 
        ...
        glUniform3f(glGetUniformLocation(shader.Program, "pointLights[1].specular"), 0.4f, 0.4f, 0.4f); 
        ...
        glUniform3f(glGetUniformLocation(shader.Program, "pointLights[2].specular"), 0.4f, 0.4f, 0.4f); 
